...
Window_Quitting.title("Three's and Cross")
...
CreditBottom1 = Label(text="THREE'S AND CROSS", font= ('Arial', 20, 'bold'), fg='black')
CreditBottom1.place(anchor= S, relx= .39, rely = .8)
CreditBottom2 = Label(text='mini project by group two', font= ('Arial', 12, 'bold'), fg='gray')
CreditBottom2.place(anchor= S, relx= .60, rely = .795)
