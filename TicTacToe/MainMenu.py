...
# Start Game to Multiplayer
Button_Start_Multi = Button(window_menu, text= "Start - Multiplayer", padx=30, fg='black', bg='#73b504', borderwidth=-1, font=('Arial', 20), command= run_game_Multiplayer,
                    activeforeground='black', activebackground='#73b504') #This prevent click button from flashing
Button_Start_Multi_Descript = Label(window_menu, text='Play against other player', font=('Arial', 12))


# Quit Game
Button_quit = Button(window_menu, text= "Quit", padx=113, fg='black', bg='#BF0000', borderwidth=-1, font=('Arial', 20), command= game_quit,
                     activeforeground='black', activebackground='#BF0000') #This prevent click button from flashing
